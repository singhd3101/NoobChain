...
public class Transaction {
	...
	//Role - only allow the owner to spend their coins, secondly they prevent
	//others from tampering with their submitted transaction before a new 
	//block is mined(at the point of entry)
